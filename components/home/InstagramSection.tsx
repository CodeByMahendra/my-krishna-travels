    ...
    <section className="py-16 md:py-20 lg:py-24 bg-white border-b border-brand-border">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-14 space-y-2 sm:space-y-3">
          <div className="inline-flex items-center gap-1.5 sm:gap-2 bg-light-blue text-primary-blue px-3 sm:px-3.5 py-1 rounded-full text-xs font-bold uppercase tracking-wider border border-primary-blue/15">
            <Instagram className="w-3.5 h-3.5 text-bright-blue" />
            <span>@krishnatravels_25</span>
          </div>
        ...
        {/* Instagram Grid - 2 cols on mobile, 4 on desktop */}

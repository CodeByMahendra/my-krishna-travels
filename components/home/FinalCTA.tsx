    ...
    <section className="py-16 md:py-20 lg:py-24 bg-navy text-white relative overflow-hidden">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 pt-2">
          <Link
            href="/customize"
            className="w-full sm:w-auto bg-primary-blue hover:bg-primary-hover text-white font-semibold text-base h-[48px] px-8 rounded-[8px] transition-colors flex items-center justify-center gap-2 shadow-xs active:scale-[0.98]"
          >
          ...
          <WhatsAppButton
            ...
            text="WhatsApp Us"
            source="FinalCTA"
            className="w-full sm:w-auto text-base h-[48px] px-8 rounded-[8px] active:scale-[0.98]"
          />
        </div>
